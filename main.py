...
template = """
    ...
    - Prioritize the user stories using the method of WSJF or another method if you think it is needed.Assign and explain the points of prioritization used for each user story.
